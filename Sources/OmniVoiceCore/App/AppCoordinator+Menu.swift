...
extension AppCoordinator {
    ...
    func permissionEntries(_ snapshot: PermissionSnapshot) -> [(label: String, granted: Bool)] {
    ...
    func permissionSummaryItem(_ snapshot: PermissionSnapshot) -> NSMenuItem {
    ...
    func permissionSummaryAttributedString(_ snapshot: PermissionSnapshot) -> NSAttributedString {
    ...
    func permissionStatusAttributedString(text: String, granted: Bool) -> NSAttributedString {
